        ...
        <div class="row">
            <div class="col-md-7 align-self-center">
                <div class="xs-banner-content">
                    <h2 class="banner-title">PAGE NOT FOUND</h2>
            ...
            <div class="col-md-5">
                <div class="xs-banner-image">
                    <img src="assets/images/404.png" data-parallax='{"y": 150}' alt="404 image">
                </div>
            </div>
        </div><!-- .row END -->
    </div><!-- .container END -->
    <div class="icon-bg" style="background-image: url(assets/images/icon-bg-3.png)"></div>
