...
<html class="no-js" lang="en">
	<head>
		...
		<title>Hostinza - Index One</title>
...
<div class="header-transparent">
        ...
        <div class="row">
            <div class="col-md-6">
                <ul class="xs-top-bar-info">
                    ...
                    <li>
                        <a href="mailto:info@domain.com"><i class="icon icon-envelope1"></i>info@netframe-it.net</a>
                    </li>
                </ul>
            </div>
            <div class="col-md-6">
                <ul class="top-menu">
                    <li><a href="https://netframe-it.net/members.php"><i class="icon icon-key2"></i> Login</a></li>
    ...
    <ul class="nav-menu">
        <li class="mega-menus"><a href="#">Home</a>
        ...
        <li class="mega-menus"><a href="#">Pages</a>
        ...
        <li class="mega-menus"><a href="#">Hosting</a>
        ...
        <li class="mega-menus"><a href="#">Elements</a>
            <div class="megamenu-panel xs-icon-menu">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-menu-item">
                            <a href="elements-features.html"><i class="icon icon-sun"></i>Feature Box</a>
                        </div>
                        <div class="single-menu-item">
                            <a href="elements-pricing-table.html"><i class="icon icon-database"></i>Pricing Table</a>
                        </div>
                        <div class="single-menu-item">
                            <a href="elements-testimonial.html"><i class="icon icon-lock"></i>Testimonial</a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="single-menu-item">
                            <a href="elements-blogpost.html"><i class="icon icon-heart"></i>Blog Post</a>
                        </div>
                        <div class="single-menu-item">
                            <a href="elements-clients.html"><i class="icon icon-printer"></i>Clients</a>
                        </div>
                        <div class="single-menu-item">
                            <a href="elements-team.html"><i class="icon icon-camera"></i>Team</a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="single-menu-item">
                            <a href="elements-domain-search.html"><i class="icon icon-phone"></i>Domain Search</a>
                        </div>
                        <div class="single-menu-item">
                            <a href="elements-calltoaction.html"><i class="icon icon-construction"></i>Call To Action</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="xs-banner-image">
                    <img src="assets/images/welcome/banner_image.png" alt="Welcome banner image">
                    <img src="assets/images/welcome/banner_icon_1.png" class="banner-ico banner-ico-1" alt="banner icon">
                    <img src="assets/images/welcome/banner_icon_2.png" class="banner-ico banner-ico-2" alt="banner icon">
                    <img src="assets/images/welcome/banner_icon_3.png" class="banner-ico banner-ico-3" alt="banner icon">
                    <img src="assets/images/welcome/banner_icon_4.png" class="banner-ico banner-ico-4" alt="banner icon">
                </div>
            </div>
        </div><!-- .row END -->
    </div><!-- .container END -->
